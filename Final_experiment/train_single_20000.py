"""
Single PPO Experiment - 20,000 Episodes
========================================

This script runs a SINGLE experiment for 20,000 episodes.
...
def main():
    ...
    print("\n" + "=" * 70)
    print("PPO PONG - SINGLE 20,000 EPISODE EXPERIMENT")
    print("=" * 70)
    print(f"\nConfiguration:")
    ...
    model_path = os.path.join(logs_dir, "ppo_20k_model.pt")
    trainer.save_model(model_path)

    # Save episode-level CSV
    csv_path = os.path.join(logs_dir, "episodes_20k.csv")
    ...
    if "entropy_history" in metrics:
        updates_csv_path = os.path.join(logs_dir, "updates_20k.csv")
    ...
    # Save summary
    summary_path = os.path.join(logs_dir, "summary_20k.txt")
    with open(summary_path, "w") as f:
        f.write("PPO PONG - 20,000 EPISODE EXPERIMENT SUMMARY\n")
        f.write("=" * 70 + "\n\n")
